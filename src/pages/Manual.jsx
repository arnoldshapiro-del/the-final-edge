      ...
      <div className="flex gap-8 print:block">
        ...
        <main className="min-w-0 flex-1 space-y-12 print:space-y-8">
          ...
          <Section id="p3" pill="cyan" label="PART THREE" sub="THE PROGRAM, SCREEN BY SCREEN" kicker="Every part of the app, what it’s for, and how to actually use it.">
            ...
            <P><X to="/learn"><Str>Learn</Str></X> — the twelve lessons. The curriculum, in the calm masterclass voice. Twelve lessons, each with a “Lock-it-in” box. Several ship with live charts: the flagship pullback → trendline-close entry chart (Lesson 3), the 2-2-2 ladder and the structure trail (Lesson 7), healthy vs. unhealthy pullback with the 20/9 EMAs (Lesson 4), and the two-step stop chart (Lesson 6). The <Em>Know The Odds</Em> card (Lesson 8) is the honest statistical reality of the system — why a loose flag is a coin flip, why a tight flag after a steep pole isn’t, and why the 15-min + 2-min-close filters are the whole edge. <Em>Method 3 — the Opening Range Break &amp; Retest</Em> (Lesson 9) applies the same flag logic to the most important level of the morning. <Em>How to use it:</Em> read all twelve once in sequence in your first couple of days, then treat Learn as reference. Re-read any lesson the day after you break its rule.</P>
          ...
          <Section id="p5" pill="emerald" label="PART FIVE" sub="THE FIRST THREE WEEKS" kicker="A concrete rhythm, so “go get your reps” has a shape.">
            <div className="card-elev rounded-card p-4 md:p-5 border border-border mt-2">
              ...
              <p className="text-textp font-body text-[15px] leading-[1.7]">Read all twelve <X to="/learn">Learn lessons</X> and walk the entire <X to="/learn/gallery">Visual Library</X>, including every Do-Not-Trade chart. Each session: full pre-market, then 10 minutes of Trainer in <Str>Instant</Str> mode before you trade sim. <Em>Goal:</Em> trap-accuracy above 90% in Instant mode. Trade sim lightly — the point this week is recognition, not volume. End every day with the review.</p>
            </div>
