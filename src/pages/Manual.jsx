      ...
      <div className="flex gap-8 print:block">
        ...
        <main className="min-w-0 flex-1 space-y-12 print:space-y-8">
          ...
          <Section id="p3" pill="cyan" label="PART THREE" sub="THE PROGRAM, SCREEN BY SCREEN" kicker="Every part of the app, what it’s for, and how to actually use it.">
            ...
            <P><X to="/learn"><Str>Learn</Str></X> — the eleven lessons. The curriculum, in the calm masterclass voice. Eleven lessons, each with a “Lock-it-in” box. Several ship with live charts: the flagship pullback → trendline-close entry chart (Lesson 3), the 2-2-2 ladder (Lesson 7), healthy vs. unhealthy pullback with the 20/9 EMAs (Lesson 4), and the two-step stop chart (Lesson 6). The new <Em>Know The Odds</Em> card (Lesson 8) is the honest statistical reality of the system — why a loose flag is a coin flip, why a tight flag after a steep pole isn’t, and why the 15-min + 2-min-close filters are the whole edge. <Em>How to use it:</Em> read all eleven once in sequence in your first couple of days, then treat Learn as reference. Re-read any lesson the day after you break its rule.</P>
